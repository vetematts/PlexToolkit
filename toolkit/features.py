...
def run_library_stats(config, pause_fn):
    """Generates and displays statistics about the Plex library."""
    clear_screen()
    print()
    print(Fore.YELLOW + f"{emojis.STATS}  Library Statistics\n")
    ...
    try:
        ...
        print(f"{emojis.INFO} Analyzing library data...")
        all_items = library.all()
        total_movies = len(all_items)
        total_collections = len(library.collections())
        ...
        print(f"\n{Fore.GREEN}--- Overview ---{Fore.RESET}")
